...
if dataset_name_test in ["SimuMix3D_128", "SimuBeads3D_128", "SimuMix3D_256"]:
    ...
    lr_root_path = os.path.join(
        path,
        "raw_psf_31_gauss_{}_poiss_{}_sf_{}_ratio_{}".format(
            std_gauss, poisson, scale_factor, ratio
        ),
    )
...
if dataset_name_test in ["ZeroShotDeconvNet"]:
    if wave_length == "642":
        path = os.path.join(
            root_path, dataset_name_test, "3D time-lapsing data_LLSM_Mitosis_H2B", "642"
        )
    if wave_length == "560":
        path = os.path.join(
            root_path,
...
if dataset_name_test in [
    ...
    path = os.path.join(root_path, "RCAN3D", "Confocal_2_STED", dataset_name_test)
...
if FP_type == "pre-trained":
    ...
    if dataset_name_train == "SimuMix3D_128":
        ...
        FP_path = os.path.join(
            ...
            "kernet_fp_bs_2_lr_1_ker_{}_gauss_{}_poiss_{}_sf_{}_mse_over2_inter_normx_fft_ratio_{}_ts_0_2_s100".format(
    ...
    if dataset_name_train == "SimuMix3D_256":
        ...
        FP_path = os.path.join(
            ...
            dataset_name_train,
            "forward",
            "kernet_fp_bs_1_lr_1_ker_{}_gauss_{}_poiss_{}_sf_{}_mse_over2_inter_normx_fft_ratio_{}_ts_3_4_s100".format(
                ker_size_fp, std_gauss, poisson, scale_factor, ratio
            ),
            "epoch_10.pt",
        )  # 50 (NF), 10 (N)
    ...
    if dataset_name_train == "F-actin_Nonlinear":
        ...
        FP_path = os.path.join(
            ...
            "kernet_fp_bs_1_lr_0.001_ker_{}_gauss_{}_poiss_{}_sf_{}_mse_over2_inter_normx_fft_ratio_1_ts_0_1_s100".format(
                ker_size_fp, std_gauss, poisson, scale_factor
            ),  # 'epoch_5000.pt')
            "epoch_500.pt",
        )
...
if BP_type == "learned":
    ...
    if dataset_name_train == "SimuMix3D_128":
        ...
        model_path = os.path.join(
            ...
            dataset_name_train,
            "backward",
            "kernet_bs_3_lr_1e-06_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_3".format(  # 'kernet_bs_1_lr_1e-06_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_1_ss'\
                num_iter_train, ker_size_bp, std_gauss, poisson, scale_factor, ratio
            ),  # 'epoch_5000.pt')
            "epoch_10000.pt",
        )
    ...
    if dataset_name_train == "SimuMix3D_256":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            "kernet_bs_1_lr_0.0005_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over4_inter_norm_fft_ratio_{}_ts_0_1_abss_mo".format(
                num_iter_train, ker_size_bp, std_gauss, poisson, scale_factor, ratio
            ),
            "epoch_1000.pt",
        )
    ...
    if dataset_name_train == "SimuMix3D_382":
        ...
        if wave_length == "642":
            model_path = os.path.join(
                ...
                "kernet_bs_1_lr_1e-07_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_9_642".format(
                    num_iter_train, ker_size_bp, std_gauss, poisson, scale_factor, ratio
                ),  # 'epoch_6000.pt')
                "epoch_4000.pt",
            )
        ...
        if wave_length == "560":
            model_path = os.path.join(
                ...
                "kernet_bs_1_lr_1e-07_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_9_560".format(
                    num_iter_train, ker_size_bp, std_gauss, poisson, scale_factor, ratio
                ),  # 'epoch_6000.pt')
                "epoch_4000.pt",
            )
    ...
    if dataset_name_train == "ZeroShotDeconvNet":
        model_path = os.path.join(
            ...
            "kernet_bs_1_lr_1e-07_iter_{}_ker_{}_noise_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_101x101_560_ss".format(
                num_iter_train, ker_size_bp, std_gauss, scale_factor, ratio
            ),
            "epoch_3000.pt",
        )
    ...
    if dataset_name_train == "Microtubule":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            "kernet_bs_1_lr_1e-05_iter_{}_ker_{}_noise_{}_sf_{}_lam_0.0_mse_over{}_inter_norm_1024".format(
                num_iter_train, ker_size_bp, std_gauss, scale_factor, over_sampling
            ),
            "epoch_5000.pt",
        )
    ...
    if dataset_name_train == "Nuclear_Pore_complex":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            "kernet_bs_1_lr_1e-06_iter_{}_ker_{}_noise_{}_sf_{}_lam_0.0_mse_over{}_inter_norm_1024".format(
                num_iter_train, ker_size_bp, std_gauss, scale_factor, over_sampling
            ),
            "epoch_5000.pt",
        )
    ...
    if dataset_name_train == "Nuclear_Pore_complex2":
        model_path = os.path.join(
            ...
            dataset_name_train,
            "backward",
            "kernet_bs_4_lr_1e-05_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over{}_inter_norm_fft_ratio_1_ts_0_4".format(
                num_iter_train,
                ker_size_bp,
                std_gauss,
                poisson,
    ...
    if dataset_name_train == "F-actin_Nonlinear":
        model_path = os.path.join(
            ...
            dataset_name_train,
            "backward",
            "kernet_bs_1_lr_1e-05_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_1".format(
                num_iter_train, ker_size_bp, std_gauss, poisson, scale_factor, ratio
            ),
            "epoch_10000.pt",
        )
    ...
    if dataset_name_train == "Microtubules2":
        model_path = os.path.join(
            ...
            "kernet_bs_1_lr_0.0001_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_1".format(
                num_iter_train, ker_size_bp, std_gauss, poisson, scale_factor, ratio
            ),  # 'epoch_5000.pt')
            "epoch_10000.pt",
        )
...
for i in id_sample:
    ...
    print("-" * 80)
    print(
        "Sample [{}], input shape:{}, GT shape:{}".format(
            i, list(x.shape), list(y.shape)
        )
    )
    ...
    y_pred_all = model(x)
    print(
        "Time : {:.2f} s, each iteration: {:.2f} s.".format(
            time.time() - ts, (time.time() - ts) / num_iter_test
        )
    )
    ...
    # Save results
    name_net = "kernelnet"
    path_single_data = os.path.join(path_fig, f"sample_{i}", name_net + suffix_net)
    if not os.path.exists(path_single_data):
        os.makedirs(path_single_data, exist_ok=True)

    imsave_sample = lambda path, fname, arr: io.imsave(
    ...
    if dataset_name_test == "ZeroShotDeconvNet":
        imsave_sample(
            path_single_data, "y_pred_all.tif", y_pred_all[-1].astype(np.uint16)
        )
    else:
