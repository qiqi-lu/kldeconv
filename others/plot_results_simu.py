...
axes[0, 2].plot(
    ker_true[Nz_kt // 2, :, Nx_kt // 2], color="black", label="True", **dict_ker_profile
)
axes[0, 2].plot(
    ker_init[Nz_kt // 2, :, Nx_kt // 2], color="blue", label="init", **dict_ker_profile
)
axes[0, 2].plot(
    ker_FP[Nz_kf // 2, :, Nx_kf // 2], color="red", label=name_net, **dict_ker_profile
)

axes[1, 2].plot(
    ker_true[:, Ny_kt // 2, Nx_kt // 2], color="black", label="True", **dict_ker_profile
)
axes[1, 2].plot(
    ker_init[:, Ny_kt // 2, Nx_kt // 2], color="blue", label="init", **dict_ker_profile
)
axes[1, 2].plot(
    ker_FP[:, Ny_kf // 2, Nx_kf // 2], color="red", label=name_net, **dict_ker_profile
)
...
nr, nc = 4, 5
fig, axes = plt.subplots(
    nrows=nr, ncols=nc, dpi=300, figsize=(2.4 * nc, 2.4 * nr), constrained_layout=True
)
...
axes[0, 2].plot(
    ker_true_fft[Nz_kf_ft // 2, :, Nx_kf_ft // 2],
    color="black",
    label="True",
    **dict_kf_fft_profile,
)
axes[0, 2].plot(
    ker_FP_fft[Nz_kf_ft // 2, :, Nx_kf_ft // 2],
    color="red",
    label=name_net,
    **dict_kf_fft_profile,
)
axes[1, 2].plot(
    ker_true_fft[:, Ny_kf_ft // 2, Nx_kf_ft // 2],
    color="black",
    label="True",
    **dict_kf_fft_profile,
)
axes[1, 2].plot(
    ker_FP_fft[:, Ny_kf_ft // 2, Nx_kf_ft // 2],
    color="red",
    label=name_net,
    **dict_kf_fft_profile,
)
...
def plot_profile(axes, psf, ker_bp, s=None, color=None, label=None):
    ...
    axes[0, 1].plot(
        a[Nz_kf_ft // 2, Ny_kf_ft // 2, Nx_kf_ft // 2 :], color=color, label=label
    )
    axes[0, 2].plot(
        b[Nz_kf_ft // 2, Ny_kf_ft // 2, Nx_kf_ft // 2 :], color=color, label=label
    )
...
plot_profile(
    ...
    ker_bp=out_wien[1],
    s=s_fft,
    color=methods_color[1],
    label=methods_name[3],
)
plot_profile(
    axes, psf=ker_FP, ker_bp=ker_BP, s=s_fft, color=methods_color[0], label=name_net
)
