...
fig_path_data = os.path.join(
    "outputs", "figures", data_set_name_test.lower(), f"scale_1_gauss_0_poiss_0_ratio_1"
)
...
data = []
data.append(x)
data.append(io.imread(os.path.join(fig_path_sample, "deconvblind", "deconv.tif")))
data.append(io.imread(os.path.join(fig_path_sample, "traditional", "deconv_20.tif")))
data.append(y_pred)
data.append(y)
data = np.array(data)
