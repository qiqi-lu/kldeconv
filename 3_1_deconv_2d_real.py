...
# dataset_info = ("F-actin-nonlinear-9", "F-actin-nonlinear-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-9", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-8", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-7", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
dataset_info = ("Microtubules2-6", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-5", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-4", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-3", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-2", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
# dataset_info = ("Microtubules2-1", "Microtubules2-9", "fp_n1_r1_bp_n1_r1")
...
# ------------------------------------------------------------------------------
# print the parameters in the params_methods[bp_type]
print("[INFO] Parameters:")
for key, value in params_methods[bp_type].items():
    print(f"  {key}: {value}")
...
for i, id in enumerate(id_sample):
    ...
    out = DCV.deconv(img_raw, num_iter=num_iter, domain="fft", verbose=False)
    ker_bp = DCV.PSF2
